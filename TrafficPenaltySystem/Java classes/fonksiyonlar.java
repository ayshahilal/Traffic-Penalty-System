...
public class fonksiyonlar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("  Ortalama ceza puanının altındakilere yapılacak indirim yüzdesini girin:");
        ...
        jLabel2.setText("  Ceza puani 50'nin altında olan ve ödenecek tutarı 0 olan kişilerin ceza puanından");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel3.setText("azaltılacak miktarı girin:");
        ...
        jLabel4.setText(" Son cezasından bu güne kadar geçen süreyi görmek için kişi T.C no'sunu yazın:");

        jButton3.setText("Gör");
        ...
        jLabel5.setText(" Ceza kaydı olup arabası olmayan kişilerin bilgileri için tıklayın:");
         ...
         try {
            ...
            ResultSet r2 = s3.executeQuery(sorgu);
                ...
                if(r2.next()){
                    ...
                    JOptionPane.showMessageDialog(this,"İsmi, Soyismi, Borcu, Son cezasından sonra geçen gün sayısı aşağıdadır:\n"+
                            "              "+obj[0]);
                }
            s3.close();
            conn.close(); 
